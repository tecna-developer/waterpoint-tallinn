...
// Совпадают с --primary/--wc светлой темы (styles.css). Держим в синхроне вручную:
// маркеры рисуются в SVG-строке, до CSS-переменных тут не дотянуться. Белый глиф на
// этих заливках даёт 5.0 и 5.67 — прежние #2d9cdb/#3d8f6d давали 3.05 и 3.93.
const CATEGORY_COLOR = { water_tap: '#1a76a8', public_toilet: '#2f7355' };
